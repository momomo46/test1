...
<div class="outer10">
  ...
  エリア
   ...
   <form action="/company/create" method="post">
      ...
      <tr><td><input  type="text" name="store_name"  class="shop">
      </td></tr>
        
      <tr><td><input type="file" name="photo_pass"  class="photo">
      </td></tr>
      
      <tr><td><input type="text" name="store_infomation" class="information"></td></tr>

      <tr><td><input type="url" size="50" name="url"  class="url">
      </td></tr>

      <tr><td><input type="text"  name="religion"  class="information2"></td></tr>

      <tr><td><input type="text" name="allergies"  class="information3">
      </td></tr>

    <tr><td><input type="text" name="store_introduction" class="information4" >
    </td></tr>
      </table>
